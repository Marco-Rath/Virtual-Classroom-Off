        ...
        <div class="container-fluid">
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="count_class" class="muted pull-left">
									Subir video en formato mp4 o pegar el iframe de video 
								</div>
                            </div>
                                ...
                                <div class="span8">
									<form class="" id="add_downloadble" method="post" enctype="multipart/form-data" name="upload">
										<div class="control-group">
											<label class="control-label" for="inputEmail">Archivo de video (mp4):</label>
											<div class="controls">
								
													
												<input name="uploaded_file"  class="input-file uniform_on" id="fileInput" type="file" />
										 
												<input type="hidden" name="MAX_FILE_SIZE" value="1048576000004500" />
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea name="content" id="ckeditor_source" style="width:75%; height:120px" Placeholder="Puede pegar el código iframe del video (640x480)" ></textarea>
											</div>
										</div>
			...
			jQuery(document).ready(function($){
				$("#add_downloadble").submit(function(e){
					$.jGrowl("Subiendo archivo......", { sticky: true });
					e.preventDefault();
					var _this = $(e.target);
					...
					$.ajax({
						...
						success: function(html){
							$.jGrowl("Video guardado correctamente", { header: 'Video Agregado' });
