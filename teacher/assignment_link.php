<div class="span3" id="sidebar"><center>
	<img id="avatar" class="img-circle" src="../admin/<?php echo $row['location']; ?>">
			<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				...
				<li class=""><a href="downloadable.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-download"></i>&nbsp;Prácticas</a></li>
				<li class=""><a href="video.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-play"></i>&nbsp;Videos</a></li>
				<li class="active"><a href="assignment.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-book"></i>&nbsp;Material Adicional</a></li>
