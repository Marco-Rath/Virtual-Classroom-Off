...
if ($_FILES['uploaded_file']['size'] >= 10485760010 * 10) {
        ...
        if (!file_exists($newname)) {
            ...
            if ((move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $newname))) {
			   ...
			   //$result = @mysql_query($qry);
				...
				$qry2 = "INSERT INTO files (fdesc,floc,fdatein,teacher_id,class_id,fname,uploaded_by) VALUES ('$filedesc','$newname1',NOW(),'$session_id','$id_class','$name','$uploaded_by')" or die(mysqli_error($con));
