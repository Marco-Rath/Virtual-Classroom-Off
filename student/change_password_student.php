        ...
        <div class="container-fluid">
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  								<div class="alert alert-info"><i class="icon-info-sign"></i> Porfavor rellene los campos indicados:</div>
								<?php
								$query = mysqli_query($con,"SELECT * from student where student_id = '$session_id'")or die(mysqli_error($con));
								...
								?>								
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										<div class="control-group">
											...
											<div class="controls">
											<input type="hidden" id="password" name="password" value="<?php echo $row['password']; ?>"  placeholder="Contraseña actual">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Re-ingrese Contraseña</label>
											<div class="controls">
											<input type="password" id="retype_password" name="retype_password" placeholder="Re-ingrese Contraseña">
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
			...
			jQuery("#change_password").submit(function(e){
					e.preventDefault();
						...
						{
						$.jGrowl("La contraseña no es igual a la  Contraseña actual  ", { header: 'Cambiar Contraseña Fallido' });
						}else if  (new_password != retype_password){
						$.jGrowl("La contraseña no es igual a la  Nueva contraseña  ", { header: 'Cambiar Contraseña Fallido' });
					...
					$.ajax({
						...
						$.jGrowl("Tu contraseña fue cambiada!", { header: 'Cambiar Contraseña Exitoso' });
						var delay = 2000;
