...
<html class="no-js">
    <head>
        <title>avgConertgg Aula Virtual</title>
		<meta name="Descripcion" content="Sistema de Aprendizaje Virtual - avgConertgg">
		<meta name="keywords" content="aula Virtual, Aula Virtual,colegios,academias, universidades">
		<meta name="author" content="gorchor">
		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1">
        <!-- Bootstrap -->
				<!--<link href="images/favicon.ico" rel="icon" type="image">-->
				<link rel="icon" type="image/jpeg" href="admin/images/blanco.jpeg" />
				...
				<meta name="viewport" content="width=device-width, initial-scale=1">
		<script src="admin/vendors/jquery-1.11.1.min.js"></script>
